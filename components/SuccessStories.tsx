    ...
    <section className="bg-white py-16">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-10 px-4 md:flex-row">
        ...
        <div className="md:w-1/3">
          <div className="mx-auto h-[100px] w-[100px] rounded-full bg-gradient-primary shadow-lg circle-full">
        ...
        <div className="md:w-2/3">
          <span className="text-[11px] font-semibold uppercase tracking-wide bg-gradient-primary bg-clip-text text-transparent">
